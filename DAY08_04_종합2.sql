...
INSERT INTO CUST_T (CUST_ID, CUST_NAME, CUST_ADDR, CUST_TEL) VALUES (CUST_SEQ.NEXTVAL, '박지성', '영국', 000-000-000);
INSERT INTO CUST_T (CUST_ID, CUST_NAME, CUST_ADDR, CUST_TEL) VALUES (CUST_SEQ.NEXTVAL, '김연아', '대한민국', 111-111-111);
INSERT INTO CUST_T (CUST_ID, CUST_NAME, CUST_ADDR, CUST_TEL) VALUES (CUST_SEQ.NEXTVAL, '장미란', '대한민국', 222-222-222);
INSERT INTO CUST_T (CUST_ID, CUST_NAME, CUST_ADDR, CUST_TEL) VALUES (CUST_SEQ.NEXTVAL, '추신수', '미국', 333-333-333);
INSERT INTO CUST_T (CUST_ID, CUST_NAME, CUST_ADDR, CUST_TEL) VALUES (CUST_SEQ.NEXTVAL, '박세리', '대한민국', NULL);
...
SELECT O.ORDER_ID, B.BOOK_NO, B.BOOK_NAME
  FROM BOOK_T B INNER JOIN ORDER_T
 WHERE ORDER_DT BETWEEN '20/07/05' AND '20/07/09';
