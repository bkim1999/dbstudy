...
CREATE TABLE LECTURE_TBL (
    ...
    CONSTRAINT FK_PROFESSOR_LECTURE FOREIGN KEY ( PROFESSOR_NO )
        REFERENCES PROFESSOR_TBL ( PROFESSOR_NO ),
    CONSTRAINT FK_COURSE_LECTURE FOREIGN KEY ( COURSE_NO )
...
CREATE TABLE ENROLL_TBL (
    ...
    CONSTRAINT FK_LECTURE_ENROLL FOREIGN KEY ( LECTURE_NO )
        REFERENCES LECTURE_TBL ( LECTURE_NO )
);
...
-- 강의테이블 행 삽입
CREATE SEQUENCE LECTURE_SEQ INCREMENT BY 1 START WITH 101 ORDER;
